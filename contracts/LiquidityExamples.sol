...
contract LiquidityExamples is IERC721Receiver {
    address public constant DAI = 0xfD434944aB01eee420f39C9b01945A99C4554346;
        ...
        )
    {
        ...
        uint amount0ToMint = 2735430000000000000000;
        uint amount1ToMint = 10000000000000;
        ...
        )
    {
        ...
        require(msg.value >= amountAdd0, "Incorrect ETH amount sent");
        ...
        uint256 excessEth = msg.value - amountAdd0;
        if (excessEth > 0) {
            // Transfer excess ETH back to the sender
            (bool success, ) = msg.sender.call{value: excessEth}("");
            require(success, "Failed to send excess ETH back");
        }
    }
    ...
    function decreaseLiquidity(uint256 _tokenId, uint128 liquidity) external returns (uint amount0, uint amount1) {
